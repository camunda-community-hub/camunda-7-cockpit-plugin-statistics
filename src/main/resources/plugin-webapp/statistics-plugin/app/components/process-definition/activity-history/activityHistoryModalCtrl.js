...
ngDefine('cockpit.plugin.statistics-plugin.activity-history', function(module) {
	...
	module.controller('activityHistoryModalCtrl', ['$scope', '$rootScope', '$modalInstance', 'DataFactory', 'SettingsFactory', 'activityId', '$filter', function($scope, $rootScope, $modalInstance, DataFactory, SettingsFactory, activityId, $filter){
