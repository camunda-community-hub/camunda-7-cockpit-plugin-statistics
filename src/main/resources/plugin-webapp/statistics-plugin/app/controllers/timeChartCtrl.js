...
ngDefine('cockpit.plugin.statistics-plugin.controllers', function(
		module) {

	module.controller('timeChartCtrl', ['$scope','DataFactory',	function($scope, DataFactory) {

				function getDurations() {
					DataFactory.durations().success(
							function(data) {
